...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '月面拟态赐福', // 您的昵称 例如 Moonquill
  BIO: process.env.NEXT_PUBLIC_BIO || 'Moonquill', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xooxy.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blessing', // 网站关键词 英文逗号隔开
